...
<a href="mailto:Niharkumar1407@gmail.com"><img src="https://img.shields.io/badge/Reach_out-0F172A?style=for-the-badge&logo=gmail&logoColor=EA4335" alt="Email" /></a>
<a href="https://learn.microsoft.com/en-us/users/NeelalaHarishNiharKumar-7058/credentials/D87B6A9D53F4D641"><img src="https://img.shields.io/badge/Azure_AI_Certified-0078D4?style=for-the-badge&logo=microsoftazure&logoColor=white" alt="AI-900" /></a>
<img src="https://komarev.com/ghpvc/?username=NiharPy&style=for-the-badge&color=22D3EE&label=VISITORS" alt="Visitors" />
...
<a href="https://github.com/NiharPy/NOKVO"><img src="https://img.shields.io/badge/NOKVO-Multi--Tenant_Voice_AI_Platform-6EE7B7?style=for-the-badge&logoColor=black" alt="NOKVO" /></a>
...
```mermaid
%%{init: {'theme':'base','themeVariables':{'lineColor':'#64748B','secondaryColor':'#E2E8F0','secondaryBorderColor':'#94A3B8','fontFamily':'ui-monospace, SFMono-Regular, Menlo, monospace','fontSize':'13px'}}}%%
flowchart LR
    C(["📞 Caller"]) --> P["Plivo<br/>telephony"]
    P -->|"WebSocket<br/>audio stream"| G["FastAPI<br/>call gateway"]
    G --> S["Sarvam AI · STT<br/>EN · HI · TE"]
    S --> R{"Router<br/>blake2b hash →<br/>home deployment"}
    R --> L["Shared Azure OpenAI pool<br/>zero idle capacity"]
    L --> T["TTS synthesis"]
    T -->|"< 1s from<br/>end-of-speech"| O(["🔊 Audio to caller"])

    BUD[("Redis<br/>Lua token budget<br/>60s · 200K")] -.->|"atomic decrement"| R
    AC[("Redis<br/>audio cache · SHA-256")] -.->|"cache hit → skip synth"| T
    G --> BG["8 idempotent<br/>background loops"] --> DB[("PostgreSQL<br/>52 tables")]

    classDef pipe fill:#0F766E,stroke:#2DD4BF,stroke-width:1.5px,color:#F0FDFA
    classDef store fill:#1E3A8A,stroke:#60A5FA,stroke-width:1.5px,color:#EFF6FF
    classDef endpt fill:#3730A3,stroke:#818CF8,stroke-width:1.5px,color:#EEF2FF
    class C,O endpt
    class P,G,S,R,L,T,BG pipe
    class BUD,AC,DB store
```
...
%%{init: {'theme':'base','themeVariables':{'lineColor':'#64748B','secondaryColor':'#E2E8F0','secondaryBorderColor':'#94A3B8','fontFamily':'ui-monospace, SFMono-Regular, Menlo, monospace','fontSize':'13px'}}}%%
flowchart LR
    U(["💬 'Build me a...'"]) --> PL["LangGraph<br/>planner"]
    Q[("Qdrant<br/>RAG memory<br/>scoped per convo")] -.->|"grounding"| PL
    PL -->|"writes plan"| DB[("PostgreSQL<br/>plan queue")]
    DB -->|"A2A protocol<br/>executor polls"| EX["LangGraph<br/>executor"]
    EX --> MCP{"MCP<br/>confirmation gate"}
    MCP -->|"approved"| ACT["Side effect<br/>form · schema · code"]
    MCP -->|"rejected"| PL
    ACT --> RS["Re-scan state"]
    RS -.->|"context never drifts"| Q

    classDef pipe fill:#0F766E,stroke:#2DD4BF,stroke-width:1.5px,color:#F0FDFA
    classDef store fill:#1E3A8A,stroke:#60A5FA,stroke-width:1.5px,color:#EFF6FF
    classDef endpt fill:#3730A3,stroke:#818CF8,stroke-width:1.5px,color:#EEF2FF
    class U endpt
    class PL,EX,MCP,ACT,RS pipe
    class Q,DB store
```
...
![RAG](https://img.shields.io/badge/RAG_pipelines-5A4FCF?style=flat-square&logo=databricks&logoColor=white)
![A2A](https://img.shields.io/badge/A2A_protocol-0EA5E9?style=flat-square&logo=protocolsdotio&logoColor=white)
...
<img height="170" src="https://github-readme-stats.vercel.app/api?username=NiharPy&show_icons=true&hide_border=true&theme=tokyonight&bg_color=00000000&title_color=22D3EE&icon_color=6EE7B7&text_color=94A3B8&include_all_commits=true&count_private=true" alt="GitHub stats" />
<img height="170" src="https://github-readme-stats.vercel.app/api/top-langs/?username=NiharPy&layout=compact&hide_border=true&theme=tokyonight&bg_color=00000000&title_color=22D3EE&text_color=94A3B8&langs_count=8" alt="Top languages" />

<img src="https://github-readme-activity-graph.vercel.app/graph?username=NiharPy&theme=tokyo-night&hide_border=true&bg_color=00000000&color=22D3EE&line=6EE7B7&point=FFFFFF&area=true&area_color=22D3EE" alt="Contribution graph" width="98%" />
...
<a href="mailto:Niharkumar1407@gmail.com"><img src="https://img.shields.io/badge/Niharkumar1407@gmail.com-0F172A?style=for-the-badge&logo=gmail&logoColor=EA4335" alt="Email" /></a>
<a href="https://www.linkedin.com/in/nihar-neelala/"><img src="https://img.shields.io/badge/Let's_talk-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn" /></a>
